...
import { apiGet, fmtEur, fmtDate, ApiError } from '@/lib/api';
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-right px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Del. Fee</th>
                ...
                return [
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex text-xs font-medium px-2 py-0.5 rounded-full ${GROUP_COLOR[order.merchant_group] ?? 'bg-gray-100 text-gray-600'}`}>
                    ...
                    <td className="px-4 py-3 text-right tabular-nums text-xs text-gray-700">
                      {fmtEur(subtotal)}
                    </td>
                    <td className="px-4 py-3 text-right tabular-nums text-xs text-gray-500">
                      {deliveryFee > 0 ? fmtEur(deliveryFee) : <span className="text-gray-300">—</span>}
                    </td>
                      ...
                      <td colSpan={8} className="px-6 py-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                          ...
                          <div>
                            ...
                            <p className="font-mono text-gray-700 break-all">{order.merchant_id}</p>
                          </div>
                          <div>
                            <p className="text-gray-400 uppercase tracking-wide font-medium mb-1">Customer</p>
                            <p className="font-mono text-gray-700 break-all">{order.customer_id}</p>
                          </div>
                          <div>
